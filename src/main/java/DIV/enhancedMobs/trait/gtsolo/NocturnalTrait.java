 ...
 * 夜判定は原典と同じ [13000, 23000)。被ダメ軽減は夜間条件付きの attributelib 属性。
 */
public final class NocturnalTrait extends Trait {
    ...
    public void initialize(LivingEntity mob, int rank) {
        // 原典の被ダメ軽減属性 (10+5n)%。夜間（原典窓）のみ成立する条件付き属性として常設。
        Mobs.setTraitAttribute(mob, id(), StandardAttributes.DAMAGE_TAKEN,
                Operation.MULTIPLY, 1 - (0.10 + 0.05 * rank), TraitConditions.NIGHT_WINDOW);
    }
